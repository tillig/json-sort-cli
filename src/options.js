 ...
 * process.cwd().
 * @param {import('editorconfig').KnownProps} argvOptions The arguments provided to the
 ...
 * @returns {import('editorconfig').KnownProps} The arguments converted into .editorconfig
 * override format.
 */
